...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24472)), "D:\\kuliah\\cuan\\frontend-gkpi\\src\\app\\loading.js"],
    ...
    const originalPathname = "/(admin_route)/admin/dashboard/ManageAdmin/Add/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(admin_route)/admin/dashboard/ManageAdmin/Add/page","pathname":"/admin/dashboard/ManageAdmin/Add","bundlePath":"app/(admin_route)/admin/dashboard/ManageAdmin/Add/page","filename":"","appPaths":[]}}
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
    ...
    const [adminName, setAdminName] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const [adminEmail, setAdminEmail] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const [adminPassword, setAdminPassword] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,7582,954,5556,3380,2451,5105,6482,8976,8369,3064], () => (__webpack_exec__(39702)));
