...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 14046)), "D:\\GitHub\\gkipi-project\\frontend-gkipi\\src\\app\\(private_route)\\user\\katalog\\page.js"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24472)), "D:\\GitHub\\gkipi-project\\frontend-gkipi\\src\\app\\loading.js"],
    ...
    const pages = ["D:\\GitHub\\gkipi-project\\frontend-gkipi\\src\\app\\(private_route)\\user\\katalog\\page.js"];

    

    const originalPathname = "/(private_route)/user/katalog/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(private_route)/user/katalog/page","pathname":"/user/katalog","bundlePath":"app/(private_route)/user/katalog/page","filename":"","appPaths":[]}}
...
function UserDashboard() {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
        if (status === "authenticated" && session?.user?.email) {
            fetch(`/api/user/katalog/${session.user.email}`).then((response1)=>{
                if (!response1.ok) {
                    (0,react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast)(`${error}`, {
                ...
                (0,react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast)(`${error1}`, {
                    hideProgressBar: true,
                    autoClose: 2000,
                    type: "error"
                });
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
        ...
        fetch("/api/katalog", {
            ...
            if (!response1.ok) {
                (0,react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast)(`${response1.error}`, {
                    hideProgressBar: true,
                    autoClose: 2000,
                    type: "error"
                });
            ...
            (0,react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast)("Submited data", {
                hideProgressBar: true,
                autoClose: 2000,
                type: "success"
            });
            ...
            (0,react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast)(`${response.error}`, {
                hideProgressBar: true,
                autoClose: 2000,
                type: "error"
            });
    ...
    const [previewedKatalog, setPreviewedKatalog] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)({});
    const tagOption = [
        "Beauty & Health",
        "Sport",
        "Property",
    ...
    const handleDeleteKatalog = (katalog)=>{
        ...
        (0,react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast)("Deleted data", {
            hideProgressBar: true,
            autoClose: 2000,
            type: "success"
        });
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: isLoading ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_app_loading__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {}) : /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("select", {
                                                ...
                                                children: [
                                                    ...
                                                    tagOption.map((tagOption)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("option", {
                                                            value: tagOption,
                                                            children: tagOption
                                                        }, tagOption))
                                                ]
                                    ...
                                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        ...
                                        children: [
                                            data.length > 0 ? data.map((katalog, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                ...
                                                children: "*No products have been added yet."
                                            }),
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\GitHub\gkipi-project\frontend-gkipi\src\app\(private_route)\user\katalog\page.js`)
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,3298,8132,5105,3500,5816,930,5285,7469,1927,9940], () => (__webpack_exec__(78147)));
