...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24472)), "D:\\GitHub\\gkipi-project\\frontend-gkipi\\src\\app\\loading.js"],
    ...
    const originalPathname = "/(private_route)/user/jobSeeker/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(private_route)/user/jobSeeker/page","pathname":"/user/jobSeeker","bundlePath":"app/(private_route)/user/jobSeeker/page","filename":"","appPaths":[]}}
...
function UserDashboard() {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
        if (status === "authenticated" && session?.user?.email) {
            fetch(`/api/user/seeker/${session.user.email}`).then((response)=>{
                if (!response.ok) {
                    (0,react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast)(`${error}`, {
                ...
                (0,react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast)(`${error1}`, {
                    hideProgressBar: true,
                    autoClose: 2000,
                    type: "error"
                });
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
        ...
        if (data?._id) {
            fetch(`/api/seeker/${data._id}`, {
                ...
                if (!response.ok) {
                    (0,react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast)(`${response.error}`, {
                        hideProgressBar: true,
                        autoClose: 2000,
                        type: "error"
                    });
                ...
                (0,react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast)("Updated data", {
                    hideProgressBar: true,
                    autoClose: 2000,
                    type: "success"
                });
        ...
        fetch("/api/seeker", {
            ...
            (0,react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast)("Uploaded data", {
                hideProgressBar: true,
                autoClose: 2000,
                type: "success"
            });
    ...
    const [sex, setSex] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [education, setEducation] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [age, setAge] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    ...
    const handleDeleteJobSeeker = (seeker)=>{
        ...
        (0,react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast)("Deleted data", {
            hideProgressBar: true,
            autoClose: 2000,
            type: "success"
        });
                        ...
                        children: [
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                ...
                                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
                                    ...
                                    className: "bg-tertiary lg:w-full p-5 flex flex-col ",
                                    children: [
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,3298,8132,5105,3500,2141,7469,1927,9940], () => (__webpack_exec__(51741)));
