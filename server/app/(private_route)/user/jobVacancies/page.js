...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 36021)), "D:\\GitHub\\gkipi-project\\frontend-gkipi\\src\\app\\(private_route)\\user\\jobVacancies\\page.js"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24472)), "D:\\GitHub\\gkipi-project\\frontend-gkipi\\src\\app\\loading.js"],
    ...
    const pages = ["D:\\GitHub\\gkipi-project\\frontend-gkipi\\src\\app\\(private_route)\\user\\jobVacancies\\page.js"];

    

    const originalPathname = "/(private_route)/user/jobVacancies/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(private_route)/user/jobVacancies/page","pathname":"/user/jobVacancies","bundlePath":"app/(private_route)/user/jobVacancies/page","filename":"","appPaths":[]}}
...
function UserDashboard() {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
        if (status === "authenticated" && session?.user?.email) {
            fetch(`/api/user/vacancy/${session.user.email}`).then((response)=>{
                if (!response.ok) {
                    (0,react_toastify__WEBPACK_IMPORTED_MODULE_7__.toast)(`${error}`, {
                ...
                (0,react_toastify__WEBPACK_IMPORTED_MODULE_7__.toast)(`${error1}`, {
                    hideProgressBar: true,
                    autoClose: 2000,
                    type: "error"
                });
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
        ...
        fetch("/api/vacancy", {
            ...
            if (!response.ok) {
                (0,react_toastify__WEBPACK_IMPORTED_MODULE_7__.toast)(`${response.error}`, {
                    hideProgressBar: true,
                    autoClose: 2000,
                    type: "error"
                });
            ...
            (0,react_toastify__WEBPACK_IMPORTED_MODULE_7__.toast)("Submited data", {
                hideProgressBar: true,
                autoClose: 2000,
                type: "success"
            });
    ...
    const [jobTitle, setJobTitle] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [company, setCompany] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [jobLocation, setJobLocation] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [notes, setNotes] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [industrytag, setIndustryTag] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    ...
    const [isPreviewModalOpen, setPreviewModalOpen] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
    const [isDeleteModalOpen, setDeleteModalOpen] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
    const [previewedVacancy, setPreviewedVacancy] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)({});
    ...
    const handleDeleteJobVacancy = (vacancy)=>{
        ...
        (0,react_toastify__WEBPACK_IMPORTED_MODULE_7__.toast)("Deleted data", {
            hideProgressBar: true,
            autoClose: 2000,
            type: "success"
        });
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: isLoading ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_app_loading__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z, {}) : /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    ...
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            ...
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
                                ...
                                className: "bg-tertiary lg:w-full h-screen p-5 flex flex-col",
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h1", {
                                        className: "font-bold text-[3rem] px-4 self-center md:text-3xl mt-8",
                                        children: "Helping hands, better futures."
                                    }),
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                    ...
                                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        ...
                                        children: [
                                            data.length > 0 ? data.map((jobVacancy, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                    className: "border-2 p-3 w-full border-black flex flex-row justify-between text-lg items-center rounded-lg my-2",
                                                    children: [
                                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                                            className: "lg:flex flex-row",
                                                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                                className: "line-clamp-1 mx-2 line-clamp-1 font-semibold",
                                                                children: [
                                                                    " ",
                                                                    jobVacancy.jobTitle
                                                                ]
                                                        ...
                                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                                                    className: `lg:p-3 p-1 rounded-full line-clamp-1 mx-3 border-2 ${jobVacancy?.approval ? "bg-green-200 border-green-600" : "bg-red-200 border-red-600"}`,
                                                                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                                                        className: "text-center",
                                                                        children: jobVacancy?.approval ? "approved" : "not approved"
                                                                    })
                                                                }),
                                                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                ...
                                                content: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                            ...
                                                            children: [
                                                                "Approval:",
                                                                previewedVacancy.approval ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                                        ...
                                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                            ...
                                                            children: [
                                                                "Job Title :",
                                                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                                                    children: previewedVacancy.jobTitle
                                                                })
                                                            ]
                                                        }),
                                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                                        ...
                                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                            ...
                                                            children: [
                                                                "Job location :",
                                                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                                                    children: previewedVacancy.location
                                                                })
                                                            ]
                                                        }),
                                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                            ...
                                                            children: [
                                                                "Company :",
                                                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                                                    children: previewedVacancy.company
                                                                })
                                                            ]
                                                        }),
                                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                            ...
                                                            children: [
                                                                "Industrial Tag :",
                                                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                                                    children: previewedVacancy.tag ? previewedVacancy.tag[0] : null
                                                                })
                                                            ]
                                                        }),
                                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                            ...
                                                            children: [
                                                                "Title Tag :",
                                                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                                                    children: previewedVacancy.tag ? previewedVacancy.tag[1] : null
                                                                })
                                                            ]
                                                        }),
                                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                            ...
                                                            children: [
                                                                "Notes :",
                                                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                                                    children: previewedVacancy.notes
                                                                })
                                                            ]
                                                        })
                                                    ]
                                            ...
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_app_components_modal__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
                                                ...
                                                content: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                    children: [
                                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                                            children: "Are you sure you want to delete this job vacancy?"
                                                        }),
                                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\GitHub\gkipi-project\frontend-gkipi\src\app\(private_route)\user\jobVacancies\page.js`)
