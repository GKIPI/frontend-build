...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 70063));
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 98460));
...
/* harmony default export */ const carousell = (__default__);
const e0 = proxy["Card"];

;// CONCATENATED MODULE: ./src/app/components/hero.js



function Hero() {
    return /*#__PURE__*/ jsx_runtime_.jsx("section", {
        className: "max-w-screen flex justify-center min-w-[50vw] min-h-[60vh]",
            ...
            children: [
                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ jsx_runtime_.jsx("div", {
                            className: "font-poppins text-center text-xs italic",
                            children: '"Bukan satu kesempatan yang khusus yang akan menjadikan Anda hebat dan sukses, tapi kesungguhan Anda untuk menjadi diri Anda yang terbaik dalam kesempatan apa pun".'
                        })
                    ]
                }),
                /*#__PURE__*/ jsx_runtime_.jsx(carousell, {})
            ]
        })
    });
}
...
// and the $$typeof value is for rendering logic to determine if the module
// is a client boundary.
const { __esModule: navbar_hero_esModule, $$typeof: navbar_hero_$$typeof } = navbar_hero_proxy;
const navbar_hero_default_ = navbar_hero_proxy.default;


/* harmony default export */ const navbar_hero = (navbar_hero_default_);
;// CONCATENATED MODULE: ./src/app/components/newsSwiper.js

const NewsSwiper = ()=>{
    return /*#__PURE__*/ _jsx("div", {
        className: "w-full flex justify-center items-center h-96 ",
        children: /*#__PURE__*/ _jsx("div", {
            className: " min-w-[75rem] h-full bg-slate-200 animate-pulse"
        })
    });
};
...
function Home() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("main", {
        className: "min-h-[100vh] flex flex-col justify-end overflow-x-hidden",
        children: [
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,3298,8132,2451,6482,4025,350,3155,9790,2107,63,8460], () => (__webpack_exec__(33743)));
